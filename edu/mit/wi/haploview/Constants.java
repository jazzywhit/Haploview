...
public interface Constants {
    ...
    public static final int BETA_VERSION = 14;
    ...
    public static final String RELEASE_DATE = "29 January, 2007";
    ...
    static final String HELP_OUTPUT = TITLE_STRING + " Command line options\n" +
            ...
            "-debug <filename>               Specify a debug file name (defaults to haploview.debug)\n" +
