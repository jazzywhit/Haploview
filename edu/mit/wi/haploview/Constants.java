...
public interface Constants {
    ...
    public static final int BETA_VERSION = 16;
    public static final String EMAIL_STRING = "haploview@broad.mit.edu";
    public static final String TITLE_STRING = "Haploview "+VERSION+"RC1";
    public static final String JAVA_VERSION = System.getProperty("java.version");
    public static final String USER_AGENT = "Haploview/" + VERSION + " Java/" + JAVA_VERSION;
    public static final String RELEASE_DATE = "31 May, 2007";
